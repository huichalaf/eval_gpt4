...
for question in questions:
    ...
    score = 0
    try:
        response = call_with_timeout(call_model, [model_base, "", question])
        score = call_with_timeout(call_gpt_4_eval, [goal, model_judge, question, response])
    ...
    try:
        response = call_with_timeout(call_model, [model_tested, "", question])
        score = call_with_timeout(call_gpt_4_eval, [goal, model_judge, question, response])
